...
\ifpdfoutput{%
	...
	\usepackage[pdftex,
		...
		pdfauthor={Oliver Stollmann},
		pdftitle={Automatic extraction of Partially Observable Markov Decision Processes from Simulink models},
		colorlinks,
		linkcolor=black,
		citecolor=black,
		filecolor=black,
...
%	\\
	...
	% \includegraphics*[width=0.24\textwidth]{media/logo_inspire_icvr} \\
...
\import{src/}{plagiarism}

\tableofcontents
\addcontentsline{toc}{chapter}{Table of Contents}
\cleardoublepage

\import{src/}{abbreviations}
